...
pub fn send_confirmation<SOCK: ToSocketAddrs>(email : &str, secret : &str, mail_server: SOCK, email_origin_domain: &str, site_name: &str) -> Result<EmailResponse> {
    ...
    let email = EmailBuilder::new()
        ...
        .html(handlebars.template_render(&email_template, &data)
